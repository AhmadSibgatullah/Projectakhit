...
@section('button')
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            <a href="{{ route('MenejemenToko.expendition.index') }}" class="btn d-none d-sm-inline-block">
                <-- Back </a>
        </div>
    </div>
@endsection
...
<div>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('MenejemenToko.expendition.store') }}" method="POST" autocomplete="off">
                        @csrf
                        @method('post')
                        <div class="row">
                            <div class="row">
